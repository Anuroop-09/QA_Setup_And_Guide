            ...
            contents: [
                {
                    ...
                    blocks: [
                        {
                            text: "After downloading the Installer file navigate to <strong>Downloads</strong> folder find the file and run the file in Adminstration mode (Right Click on File -> Click on <strong>Run as Adminstration</strong>).",
                            image: {
                                imgSource: "img/installations/java/7_jdk_initial_screen.png",
                    ...
                    blocks: [
                        {
                            ...
                            image: {
                                imgSource: "img/installations/java/8_jdk_path_location.png",
                    ...
                    blocks: [
                        {
                            ...
                            image: {
                                imgSource: "img/installations/java/9_jdk_install_progress.png",
                        ...
                        },
                        {
                            ...
                            image: {
                                imgSource: "img/installations/java/10_jdk_install_complete.png",
