export const introToFramework = {
    sectionId: "intro_to_framework",
    subsections: [
        {
        ...
        {
            subtitle: "Get Sample Project",
            projectRepo: {
                text: "Download or Clone the sample project for Selenium Java TestNG Framework on GitHub repository.",
                gitHubUrl: "https://github.com/Anuroop-09/Starters_and_Demos_of_Testing/tree/main/Selenium_Java_Starters"
            }
        }
    ]
}